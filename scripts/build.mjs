...
const required = ['index.html', 'terms/index.html', 'privacy/index.html', 'styles.css', 'site-config.js', 'script.js', 'assets/hero-genba-home.png', 'CNAME', '.nojekyll', 'robots.txt', 'sitemap.xml'];
...
for (const file of ['index.html', 'terms', 'privacy', 'styles.css', 'site-config.js', 'script.js', 'assets', 'CNAME', '.nojekyll', 'robots.txt', 'sitemap.xml']) {
